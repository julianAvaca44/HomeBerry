from whatsAppModule.yowsup.layers.protocol_presence.protocolentities.presence_unsubscribe import UnsubscribePresenceProtocolEntity
from whatsAppModule.yowsup.layers.protocol_presence.protocolentities.test_presence import PresenceProtocolEntityTest

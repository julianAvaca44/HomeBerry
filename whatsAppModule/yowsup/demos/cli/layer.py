...
from whatsAppModule.yowsup.layers import YowLayerEvent, EventCallback
...
import logging
import tempfile
from whatsAppModule.yowsup.layers.protocol_receipts.protocolentities import *
from whatsAppModule.yowsup.layers.protocol_groups.protocolentities import *
from whatsAppModule.yowsup.layers.protocol_presence.protocolentities import *
from whatsAppModule.yowsup.layers.protocol_messages.protocolentities import *
from whatsAppModule.yowsup.layers.protocol_acks.protocolentities import *
from whatsAppModule.yowsup.layers.protocol_ib.protocolentities import *
from whatsAppModule.yowsup.layers.protocol_iq.protocolentities import *
from whatsAppModule.yowsup.layers.protocol_contacts.protocolentities import *
from whatsAppModule.yowsup.layers.protocol_chatstate.protocolentities import *
from whatsAppModule.yowsup.layers.protocol_privacy.protocolentities import *
from whatsAppModule.yowsup.layers.protocol_media.protocolentities import *
from whatsAppModule.yowsup.layers.protocol_media.mediauploader import MediaUploader
from whatsAppModule.yowsup.layers.protocol_profiles.protocolentities import *
from whatsAppModule.yowsup.common.tools import ModuleTools, Jid
...
class YowsupCliLayer(Cli, YowInterfaceLayer):
    ...
    def keys_get(self, jids):
        if ModuleTools.INSTALLED_AXOLOTL():
            from whatsAppModule.yowsup.layers.axolotl.protocolentities.iq_key_get import GetKeysIqProtocolEntity
            if self.assertConnected():
                jids = [self.aliasToJid(jid) for jid in jids.split(',')]
